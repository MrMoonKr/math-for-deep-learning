...
| ----- | ------------------- | ------------------ | - | -------------- |
| 사칙연산  | +, −, ×, ÷          | arithmetic         |   |                |
| 거듭제곱  | (a^n)               | exponentiation     |   |                |
| 로그    | (\ln x), (\log_a x) | logarithm          |   |                |
| 절댓값   | (                   | x                  | ) | absolute value |
| 근     | (\sqrt[n]{x})       | root               |   |                |
| 삼각함수  | sin, cos, tan       | trigonometric      |   |                |
| 지수함수  | (e^x)               | exponential        |   |                |
| 미분    | 변화율                 | derivative         |   |                |
| 적분    | 넓이/누적               | integral           |   |                |
| 극한    | 수렴                  | limit              |   |                |
| 연속성   | limit = value       | continuity         |   |                |
| 대수 성질 | 교환/결합/분배            | algebraic laws     |   |                |
| 복소수   | (a+bi)              | complex operations |   |                |
